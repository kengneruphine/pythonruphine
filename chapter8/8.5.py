...
x = 1 + Rational(3,4)
print "when using addition",x

y = 1 - Rational(3,4)
print "for subtraction", y

y = 1 * Rational(3,4)
print "for multiplication" ,y

y = 1 / Rational(3,4)
print "for division", y

y = 1 // Rational(3,4)
print "for object on the right", y
